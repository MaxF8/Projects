...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key,Value>{
 ...
 public BTreeImpl()
 {
    ...
    // this.pm = new DocumentPersistenceManager(path);
 }
...
// }
    ...
    public Value get(Key key)
    {
        ...
        if(entry != null)
        {
            ...
            // System.out.println((Value)entry.val);
            // if ((Value)entry.getValue() == null)
            // {
            //     try {
            //        System.out.println(entry); 
            //        Object v = this.pm.deserialize((Value)key);
            //        Document doc = (Document)v;
                   
            //        System.out.println("/"+v);
            //         entry.setValue((Value)v);

            //         this.pm.delete((Value)key); //if false?
...
public Value put(Key key, Value val)
{
    ...
    {
        Value v = (Value) alreadyThere.getValue();
        alreadyThere.val = val;
        // System.out.println(originalVal.val);
    ...
    // if (originalVal != null)
    // {
    //    return  (Value)originalVal.val;    
    // }
   
    return null; //todo null? probably correct
}
 ...
 */
    ...
    // it will be written to disk via a call to BTree.moveToDisk. When a document is
    // moved to disk, the entry in the BTree has a reference to the file on disk as
    // its value instead of a reference to the document in memory. When a document
    // is written out to disk, it is removed from the MinHeap which is managing memory.
    @Override
    public void moveToDisk(Comparable k) throws Exception {
        ...
        System.out.println("move to disk");
        URI uri = (URI)k;
        // System.out.println(uri);
        Value v = get((Key)k);
        Document doc = (Document)v;
        // System.out.println(d);
        this.pm.serialize(uri, doc);
        
        // System.out.println("hi");
        // put((Key)uri,null);
        //delete
        //deserialize in get method
